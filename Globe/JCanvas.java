            ...
            try{
                switch(Alignment){
                    case 'c':
                        ...
                        break;
                    case 't':
                        Painter.drawString(Text, INTX - Metrics.stringWidth(Text) / 2, INTY + Metrics.getHeight() * 3 / 4);
                        break;
                    case 'b':
                        Painter.drawString(Text, INTX - Metrics.stringWidth(Text) / 2, INTY - Metrics.getHeight() * 1 / 4);
                        break;
                    case 'l':
        ...
        public void paintComponent(Graphics g){
            try{
               // if(Paint == null){
                ...
                //}
                Paint.drawImage(Picture, 0, 0, null);
                //paint.drawImage(Picture, AX, AY, W, H, Color.white, null);
               // Paint.drawImage(Picture, 0, 0, W, H, Color.white, null);
                if(Telemetry){
