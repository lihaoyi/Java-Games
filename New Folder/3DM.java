...
abstract class Printable3DM implements Comparable{
    Point3DM Center;
    Color Tint;
...
class Sprite3DM extends Printable3DM{
    ...
    public void printFinish(ObserverM View){
        Graphics2D Painter = View.Painter;
        Painter.setColor(Tint);
        
        Painter.draw(FinalImage);
    }
    public void printNow(Graphics2D Painter, ObserverM View){
        if(checkForBehind(View)){
            return;
        }
        center(View);
    ...
    public void printNow(Graphics2D Painter, ObserverM View, Color PrintColor){
        if(checkForBehind(View)){
            return;
        }
        center(View);
    ...
    class Shape3DM extends Printable3DM{
        ...
        final private Point3DM TransformedCenter = new Point3DM(0, 0, 0);
        ...
        public int compareTo(Object obj){
            return Double.compare(TransformedCenter.POSX, ((Shape3DM)obj).TransformedCenter.POSX);
        }
        public double getDepth(){
            return TransformedCenter.POSX;
        }
...
class Point3DM{
    ...
    public boolean equals(Point3DM Target){
    ...
    public void copyTo(Point3DM Target){
        Target.POSX = POSX;
        Target.POSY = POSY;
        Target.POSZ = POSZ;
    }
    public void copyFrom(Point3DM Target){
        POSX = Target.POSX;
        POSY = Target.POSY;
        POSZ = Target.POSZ;
...
class ObserverM{
 ...
 //   Rotation3DM InverseRotation = new Rotation3D();
    ...
    public void printAll(){
        ...
        Collections.sort(PrintingShapes);
